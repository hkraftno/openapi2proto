...
func testGenProto(t *testing.T, tests ...genProtoTestCase) {
	...
	for _, test := range tests {
		t.Run(test.fixturePath, func(t *testing.T) {
			...
			if err := openapi2protohk.Transpile(&generated, test.fixturePath, openapi2protohk.WithCompilerOptions(compilerOptions...), openapi2protohk.WithEncoderOptions(encoderOptions...)); err != nil {
...
func TestNetwork(t *testing.T) {
	testGenProto(t, genProtoTestCase{
		...
		remoteFiles: []string{
			"https://raw.githubusercontent.com/NYTimes/openapi2protohk/master/fixtures/petstore/Pet.yaml",
		},
	})
}
